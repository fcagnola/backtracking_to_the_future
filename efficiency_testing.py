...
df = process_citations('/Users/federicocagnola/PycharmProjects/backtracking_to_the_future/citations_sample.csv')


'''
l_statements = ['''a = df.query('creation.dt.year == 2001')''', '''b = df[df['creation'].dt.year == 2001]''']
l_functions = ["(query)", "(df)"]
