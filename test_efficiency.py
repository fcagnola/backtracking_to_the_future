...
l_statements = ['''process_citations_base("citations_sample.csv")''',
                ...
                '''do_compute_impact_factor(citations, {'10.3389/fpsyg.2016.01483','10.1097/mop.0000000000000929','10.1177/000313481107700711','10.3414/me14-05-0004','10.3928/01477447-20180123-06','10.1002/ddr.21369','10.3889/mmej.2015.50002','10.1016/s0140-6736(97)11096-0'}, '2016')''',
                '''do_compute_impact_factor_pandas(citations_pandas, {'10.3389/fpsyg.2016.01483','10.1097/mop.0000000000000929','10.1177/000313481107700711','10.3414/me14-05-0004','10.3928/01477447-20180123-06','10.1002/ddr.21369','10.3889/mmej.2015.50002','10.1016/s0140-6736(97)11096-0'}, '2016')''']
l_functions = ['process_citations_base()', 'process_citations_pandas()', 'do_compute_impact_factor()',
               'do_compute_impact_factor_pandas()']
